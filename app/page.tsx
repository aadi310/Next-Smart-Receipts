...
<div className="bg-white rounded-2xl shadow-md border border-gray-200 mt-4 mx-3 overflow-hidden">
  ...
  {/* Header */}
  <div className="bg-[#222222] px-5 pt-5 pb-6 text-white">
...
<div className="bg-white rounded-2xl shadow-md border border-gray-200 mt-4 mx-3 p-4">
  ...
  <div className="flex items-center justify-between mb-4">
    ...
    <h3 className="text-lg font-semibold flex items-center text-[#111111]">
      <ShoppingBagIcon className="mr-2 h-5 w-5" />
      Your Purchase
    </h3>

    <span className="text-xs font-medium border border-gray-300 text-[#222222] px-2 py-1 rounded-full bg-[#F8F8F8]">
  ...
  <div className="space-y-3">
    ...
    {currentReceipt.items.map((product) => (
      ...
      <div
        key={product.id}
        className="bg-[#F8F8F8] rounded-xl p-4 border border-gray-200"
      >
        ...
        >
          ...
          <div className="flex items-start flex-1">
            ...
            <ChevronRight
              className={`h-4 w-4 mr-2 mt-[2px] text-[#444444] transition-transform duration-200 ${
  ...
  <div className="mt-5">
    ...
    <div className="bg-[#F8F8F8] border border-gray-200 rounded-xl p-3 flex items-center justify-between">

      <div className="flex items-center">

        <div className="w-8 h-8 bg-[#222222] rounded-lg flex items-center justify-center mr-3">
...
<div className="bg-white rounded-2xl shadow-md border border-gray-200 mt-4 mx-3 p-4">
  ...
  <div className="flex items-center justify-between mb-4">
    ...
    <div className="text-[10px] font-semibold bg-[#F5F5F5] text-[#222222] border border-gray-200 px-2 py-1 rounded-full">
      In Transit
    </div>
  ...
  <div className="flex items-center justify-between mb-5">
    ...
    <div className="flex flex-col items-center text-center flex-1">
      ...
      <div className="w-8 h-8 rounded-full bg-[#222222] text-white flex items-center justify-center">
    ...
    <div className="flex-1 h-[2px] bg-[#222222]"></div>

    {/* In Transit */}
    <div className="flex flex-col items-center text-center flex-1">

      <div className="w-8 h-8 rounded-full border-2 border-[#222222] text-[#222222] flex items-center justify-center">
        <Truck className="h-4 w-4" />
      </div>

      <span className="text-[10px] font-medium text-[#222222] mt-1">
        In Transit
      </span>
  ...
  {/* Delivery Info */}
  <div className="bg-[#F8F8F8] rounded-xl border border-gray-200 p-4 text-center mb-4">
  ...
  >
    <button className="w-full bg-[#222222] text-white h-10 text-xs font-semibold rounded-xl flex items-center justify-center gap-2 transition active:scale-[0.98] hover:bg-[#111111]">
